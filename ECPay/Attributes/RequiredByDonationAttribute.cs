    ...
    public class RequiredByDonationAttribute : RequiredAttribute
    {
        ...
        public override bool IsValid(object value)
        {
            ...
            if (oPropertyName.Equals("LoveCode"))
            {
                ...
                if (oNeedCheckedValue.Equals(EDonation.Yes))
                {
            ...
            if (oPropertyName.Equals("Print"))
            {
                ...
                if (oNeedCheckedValue.Equals(EDonation.Yes) && oPropertyValue.Equals(EPrint.Yes))
                {
                    return false;
                }
            }
            ...
            if (oPropertyName.Equals("CustomerIdentifier"))
            {
                ...
                if (oNeedCheckedValue.Equals(EDonation.Yes) && !string.IsNullOrEmpty(Convert.ToString(oPropertyValue)))
                {
                    return false;
                }
            }
