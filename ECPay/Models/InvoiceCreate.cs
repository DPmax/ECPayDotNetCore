...
{
    public class InvoiceCreate : IInvoiceConfiguration
    {
        ...
        private ECustomsClearanceMark _clearanceMark = ECustomsClearanceMark.None;
        private EPrint _print = EPrint.No;
        private EDonation _donation = EDonation.No;
        private string _loveCode = string.Empty;
        private ECarruerType _carruerType = ECarruerType.None;
        private string _carruerNum = string.Empty;
        private ETaxType _taxType = ETaxType.Taxable;
        private string _salesAmount = string.Empty;
        private string _invoiceRemark = string.Empty;
        private ETheWordType _invType = ETheWordType.Normal;
        private EVat _vat = EVat.Yes;
        ...
        {
            _items = new InvoiceItemCollection();
            _merchantID = "2000132"; //廠商編號
            _relateNumber = "ECPAY" + new Random().Next(0,99999).ToString(); //商家自訂訂單編號
            _customerID = ""; //客戶代號
            _customerIdentifier = ""; //統一編號
            _customerName = ""; //客戶名稱
            _customerAddr = "ADDRESS"; //客戶地址
            _customerPhone = "0912345678"; //客戶手機號碼
            _customerEmail = "robby@calerie.com"; //客戶電子信箱
            //_clearanceMark = CustomsClearanceMarkEnum.None;//通關方式
            _print = EPrint.No; //列印註記
            _donation = EDonation.No; //捐贈註記
            _loveCode = ""; //愛心碼
            _carruerType = ECarruerType.PhoneBarcode; //載具類別
            _carruerNum = "/6G+X3LQ".Replace('+', ' '); //依API說明,把+號換成空白
            //_taxType = TaxTypeEnum.DutyFree;//課稅類別
            _salesAmount = "300"; //發票金額。含稅總金額。
            _invoiceRemark = "(robby)"; //備註
            _invType = ETheWordType.Normal; //發票字軌類別
            //_vat = VatEnum.No;//商品單價是否含稅
        ...
        EInvoiceMethod IInvoiceConfiguration._invM
        {
            get { return EInvoiceMethod.InvoiceCreate; }
        }
        ...
        /// 廠商驗證時間(自動產生)
        /// </summary>
        internal int TimeStamp { get => _timeStamp; set => _timeStamp = value; }
        /// <summary>
        /// 商家自訂訂單編號(必填) ‧預設不可重複 ‧預設最大長度為30碼
        /// </summary>
        [Required(ErrorMessage = "{0} is required.")]
        [StringLength(30, ErrorMessage = "{0} max length as {1}.")]
        public string RelateNumber { get => _relateNumber; set => _relateNumber = value; }
        /// <summary>
        ...
        public string CustomerIdentifier { get => _customerIdentifier; set => _customerIdentifier = value; }
        /// <summary>
        ...
        [RequiredByPrintFlag(ErrorMessage = "If PrintFlag equal to Yes , then {0} is required.")]
        [NeedEncode]
        public string CustomerAddr { get => _customerAddr; set => _customerAddr = value; }
        /// <summary>
        ...
        public ECustomsClearanceMark ClearanceMark { get => _clearanceMark; set => _clearanceMark = value; }
        /// <summary>
        ...
        [Required(ErrorMessage = "{0} is required.")]
        public EPrint Print { get => _print; set => _print = value; }
        /// <summary>
        ...
        /// </summary>
        [Required(ErrorMessage = "{0} is required.")]
        public EDonation Donation { get => _donation; set => _donation = value; }
        /// <summary>
        ...
        public string LoveCode { get => _loveCode; set => _loveCode = value; }
        /// <summary>
        ...
        /// </summary>
        [NonProcessValue]
        public ECarruerType carruerType { get => _carruerType; set => _carruerType = value; }
        internal string CarruerType => _carruerType.ToText();
        /// <summary>
        ...
        public string CarruerNum { get => _carruerNum; set => _carruerNum = value; }
        /// <summary>
        ...
        /// </summary>
        [Required(ErrorMessage = "{0} is required.")]
        public ETaxType TaxType { get => _taxType; set => _taxType = value; }
        /// <summary>
        /// 發票金額(必填)    ‧含稅總金額
        /// </summary>
        [Required(ErrorMessage = "{0} is required.")]
        [RegularExpression("^[0-9]+$", ErrorMessage = "{0} is incorrect format.")]
        public string SalesAmount { get => _salesAmount; set => _salesAmount = value; }
        /// <summary>
        /// 備註(選填)
        /// </summary>
        [NeedEncode]
        public string InvoiceRemark { get => _invoiceRemark; set => _invoiceRemark = value; }
        ...
        /// </summary>
        internal string ItemCount => _items.ItemCount;
        ...
        /// </summary>
        [NeedEncode]
        internal string ItemWord => _items.ItemWord;
        ...
        ///                       ‧含稅單價金額
        /// </summary>
        internal string ItemPrice => _items.ItemPrice;
        ...
        /// </summary>
        internal string ItemTaxType => _items.ItemTaxType;
        ...
        internal string ItemAmount => _items.ItemAmount;
        ...
        internal string ItemRemark => _items.ItemRemark;
        ...
        /// </summary>
        [NonProcessValue]
        public ETheWordType invType { get => _invType; set => _invType = value; }

        internal string InvType => _invType.ToText();
        /// <summary>
        ...
        /// </summary>
        [NeedEncode]
        public string InvCreateDate { get => _invCreateDate; set => _invCreateDate = (string.IsNullOrEmpty(value)) ? DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") : value; }
        /// <summary>
        /// 商品單價是否含稅(選填)      ‧固定給定下述預設值 ->若為含稅價，則VAL = 'Yes'
        ///                                                  ->若為未稅價時，則VAL = 'No'
        ///                             ‧如無填寫或空值 ->預設值為Yes (含稅價)
        /// </summary>
        public EVat vat { get => _vat; set => _vat = value; }
        /// <summary>
        /// 商品資訊的集合別(必填)
        /// </summary>
        [NeedDetailValid]
        public InvoiceItemCollection Items { get => _items; set => _items = value; }

        //public string AllPayMid { get => _allPayMid; set => _allPayMid = value; }
    }
}
